...
impl StarMemoryPool {
    fn new(count: usize) -> Self {
        // Align count to SIMD batch size
    ...
    fn create_aligned_vec(size: usize, default_value: f32) -> Vec<f32> {
        // WASM allocator provides sufficient alignment
