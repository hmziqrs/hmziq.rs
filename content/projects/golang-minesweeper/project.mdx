...
> Or you can download directly from the <a href="https://github.com/hmziqrs/go-minesweeper/releases" target="_blank" rel="noopener noreferrer">release section</a> of the GitHub repository for your OS.
