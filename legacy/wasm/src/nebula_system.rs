...
// use crate::particle_pool::{ParticleData, ParticlePool};
use crate::physics_utils::{FastRandom, PhysicsUtils};
use js_sys::Float32Array;
use wasm_bindgen::prelude::*;

// Temporary ParticleData struct
...
impl ParticleData {
    ...
    fn unpack_color(&self) -> (u8, u8, u8, u8) {
        let r = (self.color_packed & 0xFF) as u8;
        let g = ((self.color_packed >> 8) & 0xFF) as u8;
        let b = ((self.color_packed >> 16) & 0xFF) as u8;
        let a = ((self.color_packed >> 24) & 0xFF) as u8;
        (r, g, b, a)
    }
}
