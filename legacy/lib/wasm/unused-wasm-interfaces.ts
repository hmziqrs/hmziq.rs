...
export interface BezierWASMInterface {
  ...
  precalculate_bezier_path_uniform: (
    start_x: number,
    start_y: number,
    control_x: number,
    control_y: number,
...
export interface BatchTransfer {
  transfer_particle_data: (
    positions: Float32Array,
    velocities: Float32Array,
    colors: Float32Array,
    life_values: Float32Array
  ) => Float32Array
  transfer_meteor_data: (
    positions: Float32Array,
    velocities: Float32Array,
    colors: Float32Array,
    life_values: Float32Array,
  ...
  transfer_render_data_optimized: (
    data: Float32Array,
    offset: number,
    stride: number
  ) => Float32Array
...
export interface LegacyWASMInterface
  extends BezierWASMInterface,
    LODWASMInterface,
