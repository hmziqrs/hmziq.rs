      ...
      >
        ...
        <motion.div className="space-y-8 text-lg md:text-xl leading-relaxed">
          <motion.p className="text-gray-300" variants={itemVariants}>
            ...
            building scalable solutions. With a decade of experience spanning frontend, backend, and
            cross-platform development.
          </motion.p>

          <motion.p className="text-gray-400" variants={itemVariants}>
            My expertise lies in creating performant applications using modern technologies like{' '}
            <span className="text-white">TypeScript</span>,
            <span className="text-white"> React</span>,<span className="text-white"> Next.js</span>,
            and
            <span className="text-white"> Rust</span>. I believe in writing clean, maintainable code
